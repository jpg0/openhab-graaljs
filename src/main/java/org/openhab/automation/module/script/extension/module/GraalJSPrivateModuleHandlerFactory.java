...
/**
 * The {@link GraalJSPrivateModuleHandlerFactory} is used to provide types for "private" scripted Actions, Triggers and
...
public class GraalJSPrivateModuleHandlerFactory extends BaseModuleHandlerFactory {
    ...
    private final Logger logger = LoggerFactory.getLogger(
            GraalJSPrivateModuleHandlerFactory.class);
