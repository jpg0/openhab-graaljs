...
/**
 * Bidirectional bag of unique elements. A map allowing multiple, unique values to be stored against a single key. Provides
 * optimized lookup of values for a key, as well as keys referencing a value.
 *
